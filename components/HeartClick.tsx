            ...
            <motion.div initial={{ opacity: 0, scale: 0.5 }}
                ...
                <div className={`bgoverlay flex justify-center items-center ${open && 'open'}`}>
                    <div className="relative">
                        ...
                        <span onClick={() => setOpen(true)} className={'title font-bold text-5xl text-white cursor-pointer absolute -mt-6 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-nowrap'} style={{
